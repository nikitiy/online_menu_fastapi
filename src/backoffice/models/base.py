...
class Base(DeclarativeBase):
    ...
    # A pragmatic, informative repr for debugging and logs.
    # Shows primary key(s) and a couple of representative string-ish attributes
    # such as "slug" or "name" when present.
    def __repr__(self) -> str:  # pragma: no cover - trivial formatting
        ...
        try:
            ...
            # Include primary key columns first (optional)
            pk_keys: List[str] = []
            if show_pk:
            ...
            # Only include explicitly configured fields; no implicit fallbacks
            ...
            # Fallback in case object is in a half-constructed state
            return f"<{cls_name}>"

    # Make str() mirror repr() for consistency in logs
